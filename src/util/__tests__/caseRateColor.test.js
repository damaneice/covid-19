...
describe("Case rate color", () => {
  ...
  it("returns rgb(235, 232, 2)  color", () => {
    expect(getCaseRateColor({ rateOfChange: -4 })).toBe("rgb(201, 235, 2)")
  })
  it("returns rgb(201, 235, 2) color", () => {
    expect(getCaseRateColor({ rateOfChange: -9 })).toBe("rgb(143, 235, 2)")
  })
  it("returns rgb(143, 235, 2) color", () => {
    expect(getCaseRateColor({ rateOfChange: -14 })).toBe("rgb(120, 235, 2)")
  })
